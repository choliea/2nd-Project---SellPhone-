								...
								<table align=center width=80% border="0" cellpadding="0"
									...
									<tr>
										...
										<td width=50 height=25 align="center" bgcolor="#e1f5e1"
											class=t1><font size="1">전체선택</font><br>
											<input 	
													type="checkbox" 
													id="all"
													
													onchange="cart_item_select_all();" 
										...
										<td width=50 height=25 align="center" bgcolor="#e1f5e1"
											class=t1><font>비 고</font></td>
 																				...
 																				if (cartList.size() < 1) {
 																					%>
 																					<tr>
 																					<td colspan="5" width=100 height=50 align=center bgcolor="ffffff" class=t1><font color="#808080" >장바구니 물품이 없습니다.</font></td>
								...
								<tr>
									<td align=center>
																			<%
 																				if (cartList.size() >= 1) {
 																					%> <a
										href="javascript:cart_view_form_select_order_submit();" class=m1>총
											<span style="font-weight: bold;" id="cart_item_select_count"></span>개
											주문하기[주문폼]
