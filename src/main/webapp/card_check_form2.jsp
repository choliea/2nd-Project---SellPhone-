...
<body>
<form method="POST" action="card_check_action2.jsp" name="card_check_f" id="card_check_f">
	카드 결제<br>
	<table>
		<tr>
			<td>카드번호</td>
		...
		<tr>
			<td>유효기간</td>
			<td>
			<input type="text" name="cardExpireYear" value="YYYY">
			<input type="text" name="cardExpireMonth" value="MM">
			<input type="text" name="cardExpireDay" value="DD">
			</td>
		</tr>
		<tr>
			<td>이름</td>
