...
CREATE TABLE SPEC(
		...
		spec_network                  		VARCHAR2(100)		 NULL ,
		spec_brand                    		VARCHAR2(100)		 NULL ,
		spec_release                  		DATE		 NULL ,
		spec_color                    		VARCHAR2(100)		 NULL ,
		spec_display                  		VARCHAR2(100)		 NULL ,
		spec_size                     		VARCHAR2(300)		 NULL ,
		spec_weight                   		VARCHAR2(100)		 NULL ,
		spec_RAM                      		VARCHAR2(100)		 NULL ,
		spec_battery                  		VARCHAR2(100)		 NULL ,
		spec_OS                       		VARCHAR2(100)		 NULL ,
		spec_cam                      		VARCHAR2(300)		 NULL 
);
...
CREATE TABLE BANK_PAY(
		...
		account_owner                 		VARCHAR2(200)		 NULL 
);
...
CREATE TABLE ORDERS(
		...
		delivery_status               		VARCHAR2(100)		 NULL ,
...
CREATE TABLE BOARD(
		...
		board_readcount               		NUMBER(10)		 DEFAULT 0		 NULL ,
		board_groupno                 		NUMBER(10)		 NOT NULL,
...
ALTER TABLE ORDERS ADD CONSTRAINT IDX_ORDERS_FK1 FOREIGN KEY (payment_no) REFERENCES PAYMENT (payment_no);
